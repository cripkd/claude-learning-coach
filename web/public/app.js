...
// ─── Coach markdown rendering ────────────────────────────────────────────────
// The coach's messages are markdown (headings, bold, lists, hr, code) — shown
// as literal '**text**'/'##'/'---' when rendered as plain text, which is most
// of what makes a session read as a wall of text. This is a small block parser
// covering exactly what CLAUDE.md.template actually produces, not a general
// markdown implementation. User messages are left as plain text (textContent),
// unaffected — only coach output goes through this.
//
